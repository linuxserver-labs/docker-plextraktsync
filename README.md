...
<!-- Please read the https://github.com/linuxserver/docker-plextraktsync/blob/main/.github/CONTRIBUTING.md -->
...
* image version number
  * `docker inspect -f '{{ index .Config.Labels "build_version" }}' lscr.io/linuxserver/plextraktsync`
...
* Update the image: `docker pull lscr.io/linuxserver/plextraktsync`
